...
def compress_shape_item(color: str, material: int, x: int, y: int, z: int):
    ...
    color_material = short_string_to_felt(color) * (2 ** 128) + material
...
def uncompress_shape_item(col_mat: int, x_y_z: int):
    color: int = col_mat // 2 ** 128
    mat: int = col_mat & 0xffffffffffffffff
