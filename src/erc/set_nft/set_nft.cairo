...
mod SetNft {
    ...
    use briq_protocol::erc::set_nft::systems::{set_nft_mint, set_nft_burn };
    ...
    #[constructor]
    fn constructor(ref self: ContractState, world: IWorldDispatcher, owner: ContractAddress, ) {
    ...
    fn mint(ref self: ContractState, to: ContractAddress, token_id: u256) {
        ...
        calldata.append(u256_into_felt252(token_id));
        calldata.append(to.into());
        self.world.read().execute('set_nft_mint'.into(), calldata);
