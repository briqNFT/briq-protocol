...
mod ERC721Approve {
    ...
    fn execute(ctx: Context, params: ERC721ApproveParams) {
        ...
        ERC721TokenApprovalTrait::approve(ctx.world, TOKEN_OVERRIDE(), token_id, to,);
...
mod ERC721TransferFrom {
    ...
    fn execute(ctx: Context, params: ERC721TransferFromParams) {
        ...
        ERC721OwnerTrait::set_owner(ctx.world, TOKEN_OVERRIDE(), token_id, to);
        ERC721BalanceTrait::transfer_token(ctx.world, token, from, to, 1);
        ERC721TokenApprovalTrait::approve(ctx.world, TOKEN_OVERRIDE(), token_id, Zeroable::zero());
...
mod ERC721Mint {
    ...
    fn execute(ctx: Context, params: ERC721MintParams) {
        ...
        ERC721OwnerTrait::set_owner(ctx.world, TOKEN_OVERRIDE(), token_id, recipient);
        // emit events
...
mod ERC721Burn {
    ...
    fn execute(ctx: Context, params: ERC721BurnParams) {
        ...
        ERC721OwnerTrait::set_owner(ctx.world, TOKEN_OVERRIDE(), token_id, Zeroable::zero());
