...
fn test_create_collections() {
...

    {
        ...
        CreateCollectionData { collection_id: 1, params: 2, admin_or_system: starknet::contract_address_const::<0xfafa>() }.serialize(ref calldata);
        world.execute('create_collection', (calldata));
    }

    {
        let mut calldata: Array<felt252> = ArrayTrait::new();
        CreateCollectionData { collection_id: 2, params: 2, admin_or_system: starknet::contract_address_const::<0xfafa>() }.serialize(ref calldata);
        world.execute('create_collection', (calldata));
    }
}
